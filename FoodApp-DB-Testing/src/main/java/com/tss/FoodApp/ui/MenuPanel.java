...
import com.tss.FoodApp.exceptions.MenuItemNotFoundException;
...
public class MenuPanel {
    ...
    private void tagMenuItem(int resId) {
        try {
            ...
            switch (tagChoice) {
                case 1 -> item.setBestSeller(true);
                case 2 -> item.setSpicy(true);
                case 3 -> item.setNew(true);
                default -> {
            ...
            menuService.updateItemTags(resId, item);
