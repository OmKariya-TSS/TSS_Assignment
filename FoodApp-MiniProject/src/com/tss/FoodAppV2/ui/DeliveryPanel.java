...
import com.tss.FoodAppV2.exceptions.AgentNotAvailableException;
...
import com.tss.FoodAppV2.service.interfaces.IDeliveryService;
...
public class DeliveryPanel {
    ...
    public void addDeliveryAgent() {
        try {
            ...
            DeliveryAgent agent = new DeliveryAgent(deliveryAgentCount++, name, phone, password);
