...
import com.tss.FoodAppV3.service.interfaces.IAgentAuthService;
    ...
    private List<Order> getMyActiveOrders() {
        ...
        return orderService.getAllOrders().stream()
                .filter(o -> o.getAssignedAgent() != null
                        && o.getAssignedAgent().getAgentId() == fresh.getAgentId()
                        && (o.getStatus() == OrderStatus.OUT_FOR_DELIVERY || o.getStatus() == OrderStatus.CONFIRMED ))
                .toList();
    }
}