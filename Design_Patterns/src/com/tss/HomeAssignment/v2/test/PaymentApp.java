        ...
        while (true) {
            ...
            switch (categoryChoice) {
                case 1:
                    ...
                    switch (ecomChoice) {
                        case 1: applicationFactory = new AmazonFactory(); break;
                        case 2: applicationFactory = new FlipkartFactory(); break;
                        case 0: continue;
                        default:
                ...
                case 2:
                    ...
                    switch (gameChoice) {
                        case 1: applicationFactory = new BGMIFactory(); break;
                        case 2: applicationFactory = new FortniteFactory(); break;
                        case 0: continue;
                        default:
                            System.out.println("Invalid choice! Try again.");
                            continue;
            ...
            switch (paymentChoice) {
                case 1: paymentFactory = new UPIPaymentFactory(); break;
                case 2: paymentFactory = new CreditCardPaymentFactory(); break;
                case 3: paymentFactory = new DebitCardFactory(); break;
                case 0: continue;
                default:
