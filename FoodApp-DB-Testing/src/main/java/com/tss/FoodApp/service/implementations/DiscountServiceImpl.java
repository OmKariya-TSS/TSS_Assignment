...
public class DiscountServiceImpl implements IDiscountService {
    ...
    private final IDiscountConfigRepo discountRepo;

    public DiscountServiceImpl(DiscountContext discountContext, IDiscountConfigRepo discountRepo) {
    ...
    public void updateThreshold(double threshold) {
        ...
        switch (type) {
            ...
            case "NONE" -> discountContext.setStrategy(new NoDiscountStrategy());
